...
char choix_action(obj** tab, int hauteur, int largeur, int val_max, int nb_chiffres, coord* coordonnees);
void execute_action(obj** tab, int hauteur, int largeur, int* val_max, int* cases_vides, int nb_tour, char action, coord coordonnees);
